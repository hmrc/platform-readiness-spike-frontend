...
import forms.buildResilience.ServiceURLFormProvider
...
import views.html.buildResilience.ServiceURLView
...
class ServiceURLControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val serviceURLRoute = buildRoutes.ServiceURLController.onPageLoad(NormalMode).url
  ...
  "ServiceURL Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        verify(mockSessionService).setUserAnswers(any())(any())
      }
    }
