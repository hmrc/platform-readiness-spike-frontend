...
import forms.buildResilience.DoesNonstandardPatternFormProvider
...
import views.html.buildResilience.DoesNonstandardPatternView
...
class DoesNonstandardPatternControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val doesNonstandardPatternRoute = buildRoutes.DoesNonstandardPatternController.onPageLoad(NormalMode).url
