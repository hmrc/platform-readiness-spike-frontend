...
import forms.buildResilience.ReadMeFitForPurposeFormProvider
...
class ReadMeFitForPurposeControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val readMeFitForPurposeRoute = buildRoutes.ReadMeFitForPurposeController.onPageLoad(NormalMode).url
